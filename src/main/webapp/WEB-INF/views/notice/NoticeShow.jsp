   ...
   <form action="notlceProc" name="form1" method="post">
     ...
     <table class="text-center">
       <tr>
          <th>
          <c:if test='${ssKey.m_role==admin}'>
           <input name="update" type="button"  class="btn btn-outline-success"
             value="공지사항수정" >
           <input name="delete" type="button"  class="btn btn-outline-success"
             value="공지사항삭제" >
     	  </c:if>
           <input name="list" type="button"  class="btn btn-outline-secondary"
             value="공지사항목록" onclick="location.href='/admin/noticeForm'">
          </th>
        </tr>
     </table>
   </form>
